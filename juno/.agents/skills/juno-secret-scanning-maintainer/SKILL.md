---
name: juno-secret-scanning-maintainer
description: Maintainer-only workflow for handling GitHub Secret Scanning alerts on Juno. Use when Codex needs to triage, redact, clean up, and resolve secret leakage found in issue comments, issue bodies, PR comments, or other GitHub content.
---

# Juno Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/juno/juno/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/juno-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/juno/juno/issues/63101#issuecomment-xxx",
