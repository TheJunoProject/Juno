...
function buildInputOptions(options: InputOptionsArg): InputOptionsReturn {
  if (process.env.JUNO_BUILD_VERBOSE === "1") {
    return undefined;
  }
...
const shouldBuildPrivateQaEntries = process.env.JUNO_BUILD_PRIVATE_QA === "1";
...
function shouldStageBundledPluginRuntimeDependencies(packageJson: unknown): boolean {
  return (
    ...
    packageJson !== null &&
    (packageJson as { juno?: { bundle?: { stageRuntimeDependencies?: boolean } } }).juno
