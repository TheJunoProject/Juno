...
<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/juno/juno/main/docs/assets/juno-logo-text-dark.svg">
        <img src="https://raw.githubusercontent.com/juno/juno/main/docs/assets/juno-logo-text.svg" alt="Juno" width="500">
    </picture>
</p>
...
**Juno** is a _personal AI assistant_ you run on your own devices.
...
Preferred setup: run `juno onboard` in your terminal.
Juno Onboard guides you step by step through setting up the gateway, workspace, channels, and skills. It is the recommended CLI setup path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
  ...
  <tr>
    <td align="center" width="16.66%">
      <a href="https://openai.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/juno/juno/main/docs/assets/sponsors/openai-light.svg">
          <img src="https://raw.githubusercontent.com/juno/juno/main/docs/assets/sponsors/openai.svg" alt="OpenAI" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://github.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/juno/juno/main/docs/assets/sponsors/github-light.svg">
          <img src="https://raw.githubusercontent.com/juno/juno/main/docs/assets/sponsors/github.svg" alt="GitHub" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.nvidia.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/juno/juno/main/docs/assets/sponsors/nvidia.svg">
          <img src="https://raw.githubusercontent.com/juno/juno/main/docs/assets/sponsors/nvidia-dark.svg" alt="NVIDIA" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://vercel.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/juno/juno/main/docs/assets/sponsors/vercel-light.svg">
          <img src="https://raw.githubusercontent.com/juno/juno/main/docs/assets/sponsors/vercel.svg" alt="Vercel" height="24">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://blacksmith.sh/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/juno/juno/main/docs/assets/sponsors/blacksmith-light.svg">
          <img src="https://raw.githubusercontent.com/juno/juno/main/docs/assets/sponsors/blacksmith.svg" alt="Blacksmith" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.convex.dev/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/juno/juno/main/docs/assets/sponsors/convex-light.svg">
          <img src="https://raw.githubusercontent.com/juno/juno/main/docs/assets/sponsors/convex.svg" alt="Convex" height="24">
        </picture>
      </a>
    </td>
  </tr>
...
Model note: while many providers and models are supported, prefer a current flagship model from the provider you trust and already use. See [Onboarding](https://docs.juno.ai/start/onboarding).
...
# or: pnpm add -g juno@latest

juno onboard --install-daemon
```

Juno Onboard installs the Gateway daemon (launchd/systemd user service) so it stays running.

## Quick start (TL;DR)

Runtime: **Node 24 (recommended) or Node 22.16+**.

Full beginner guide (auth, pairing, channels): [Getting started](https://docs.juno.ai/start/getting-started)

```bash
juno onboard --install-daemon

juno gateway --port 18789 --verbose

# Send a message
juno message send --to +1234567890 --message "Hello from Juno"
...
juno agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.juno.ai/install/updating) (and run `juno doctor`).

Models config + CLI: [Models](https://docs.juno.ai/concepts/models). Auth profile rotation + fallbacks: [Model failover](https://docs.juno.ai/concepts/model-failover).

## Security defaults (DM access)

Juno connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.juno.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dmPolicy="pairing"` / `channels.slack.dmPolicy="pairing"`; legacy: `channels.discord.dm.policy`, `channels.slack.dm.policy`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `juno pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.allowFrom` / `channels.slack.allowFrom`; legacy: `channels.discord.dm.allowFrom`, `channels.slack.dm.allowFrom`).

Run `juno doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.juno.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.juno.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), IRC, Microsoft Teams, Matrix, Feishu, LINE, Mattermost, Nextcloud Talk, Nostr, Synology Chat, Tlon, Twitch, Zalo, Zalo Personal, WeChat, QQ, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.juno.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.juno.ai/nodes/voicewake) + [Talk Mode](https://docs.juno.ai/nodes/talk)** — wake words on macOS/iOS and continuous voice on Android (ElevenLabs + system TTS fallback).
- **[Live Canvas](https://docs.juno.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.juno.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.juno.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.juno.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.juno.ai/nodes).
- **[Onboarding](https://docs.juno.ai/start/wizard) + [skills](https://docs.juno.ai/tools/skills)** — onboarding-driven setup with bundled/managed/workspace skills.
...
- Before exposing anything remotely, read [Security](https://docs.juno.ai/gateway/security), [Docker sandboxing](https://docs.juno.ai/install/docker), and [Configuration](https://docs.juno.ai/gateway/configuration).
...
- Skills registry: [JunoHub](https://junohub.com)
- Architecture overview: [Architecture](https://docs.juno.ai/concepts/architecture)

## Docs by goal

- New here: [Getting started](https://docs.juno.ai/start/getting-started), [Onboarding](https://docs.juno.ai/start/wizard), [Updating](https://docs.juno.ai/install/updating)
- Channel setup: [Channels index](https://docs.juno.ai/channels), [WhatsApp](https://docs.juno.ai/channels/whatsapp), [Telegram](https://docs.juno.ai/channels/telegram), [Discord](https://docs.juno.ai/channels/discord), [Slack](https://docs.juno.ai/channels/slack)
- Apps + nodes: [macOS](https://docs.juno.ai/platforms/macos), [iOS](https://docs.juno.ai/platforms/ios), [Android](https://docs.juno.ai/platforms/android), [Nodes](https://docs.juno.ai/nodes)
- Config + security: [Configuration](https://docs.juno.ai/gateway/configuration), [Security](https://docs.juno.ai/gateway/security), [Docker sandboxing](https://docs.juno.ai/install/docker)
- Remote + web: [Gateway](https://docs.juno.ai/gateway), [Remote access](https://docs.juno.ai/gateway/remote), [Tailscale](https://docs.juno.ai/gateway/tailscale), [Web surfaces](https://docs.juno.ai/web)
- Tools + automation: [Tools](https://docs.juno.ai/tools), [Skills](https://docs.juno.ai/tools/skills), [Cron jobs](https://docs.juno.ai/automation/cron-jobs), [Webhooks](https://docs.juno.ai/automation/webhook), [Gmail Pub/Sub](https://docs.juno.ai/automation/gmail-pubsub)
- Internals: [Architecture](https://docs.juno.ai/concepts/architecture), [Agent](https://docs.juno.ai/concepts/agent), [Session model](https://docs.juno.ai/concepts/session), [Gateway protocol](https://docs.juno.ai/reference/rpc)
- Troubleshooting: [Channel troubleshooting](https://docs.juno.ai/channels/troubleshooting), [Logging](https://docs.juno.ai/logging), [Docs home](https://docs.juno.ai)
...
Note: signed builds required for macOS permissions to stick across rebuilds (see [macOS Permissions](https://docs.juno.ai/platforms/mac/permissions)).

### iOS node (optional)

- Pairs as a node over the Gateway WebSocket (device pairing).
- Voice trigger forwarding + Canvas surface.
- Controlled via `juno nodes …`.

Runbook: [iOS connect](https://docs.juno.ai/platforms/ios).

### Android node (optional)

- Pairs as a WS node via device pairing (`juno devices ...`).
- Exposes Connect/Chat/Voice tabs plus Canvas, Camera, Screen capture, and Android device command families.
- Runbook: [Android connect](https://docs.juno.ai/platforms/android).
...
# First run only (or after resetting local Juno config/workspace)
pnpm juno setup
...
`pnpm juno setup` writes the local config/workspace needed for `pnpm gateway:watch`. It is safe to re-run, but you normally only need it on first setup or after resetting local state. `pnpm gateway:watch` does not rebuild `dist/control-ui`, so rerun `pnpm ui:build` after `ui/` changes or use `pnpm ui:dev` when iterating on the Control UI. If you want this checkout to run onboarding directly, use `pnpm juno onboard --install-daemon`.

Note: `pnpm juno ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `juno` binary, while `pnpm gateway:watch` rebuilds the runtime on demand during the dev loop.
...
Switch channels (git + npm): `juno update --channel stable|beta|dev`.
Details: [Development channels](https://docs.juno.ai/install/development-channels).

## Agent workspace + skills

- Workspace root: `~/.juno/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.juno/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.juno/juno.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.juno.ai/gateway/configuration)

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=juno/juno&type=date&legend=top-left)](https://www.star-history.com/#juno/juno&type=date&legend=top-left)
...
[![Mathias Nagler](https://avatars.githubusercontent.com/u/9951231?v=4&s=48)](https://github.com/mathiasnagler) [![Sean McLellan](https://avatars.githubusercontent.com/u/760674?v=4&s=48)](https://github.com/Oceanswave) [![gumjuno](https://avatars.githubusercontent.com/u/265388744?v=4&s=48)](https://github.com/gumjuno) [![RichardCao](https://avatars.githubusercontent.com/u/4612401?v=4&s=48)](https://github.com/RichardCao) [![MKV21](https://avatars.githubusercontent.com/u/4974411?v=4&s=48)](https://github.com/MKV21) [![petter-b](https://avatars.githubusercontent.com/u/62076402?v=4&s=48)](https://github.com/petter-b) [![CodeForgeNet](https://avatars.githubusercontent.com/u/166907114?v=4&s=48)](https://github.com/CodeForgeNet) [![Johnson Shi](https://avatars.githubusercontent.com/u/13926417?v=4&s=48)](https://github.com/johnsonshi) [![durenzidu](https://avatars.githubusercontent.com/u/38130340?v=4&s=48)](https://github.com/durenzidu) [![dougvk](https://avatars.githubusercontent.com/u/401660?v=4&s=48)](https://github.com/dougvk)
