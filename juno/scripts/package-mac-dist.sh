...
# Output:
# - dist/Juno.app
# - dist/Juno-<version>.zip
# - dist/Juno-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.juno.mac}"
...
ZIP="$ROOT_DIR/dist/Juno-$VERSION.zip"
DMG="$ROOT_DIR/dist/Juno-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Juno-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Juno-$VERSION.dSYM.zip"
