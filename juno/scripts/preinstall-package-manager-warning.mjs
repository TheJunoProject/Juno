...
export function createPackageManagerWarningMessage(packageManager) {
  ...
  return [
    `[juno] warning: detected ${packageManager} for install lifecycle.`,
    "[juno] this repo works best with pnpm; npm-compatible installs are slower and much larger here.",
    "[juno] prefer: corepack pnpm install",
  ].join("\n");
}
