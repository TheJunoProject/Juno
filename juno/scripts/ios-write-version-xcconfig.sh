...
- JUNO_IOS_VERSION = exact canonical iOS version
- JUNO_MARKETING_VERSION = short iOS/App Store version
- JUNO_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
JUNO_IOS_VERSION = ${IOS_VERSION}
JUNO_MARKETING_VERSION = ${MARKETING_VERSION}
JUNO_BUILD_VERSION = ${BUILD_NUMBER}
EOF
