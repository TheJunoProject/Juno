...
const codexRepo = process.env.JUNO_CODEX_REPO
  ? path.resolve(process.env.JUNO_CODEX_REPO)
...
console.log(
  `Codex app-server generated protocol matches Juno bridge assumptions: ${schemaRoot}`,
);
