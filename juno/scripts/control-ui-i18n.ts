...
const ENV_PROVIDER = "JUNO_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "JUNO_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "JUNO_CONTROL_UI_I18N_THINKING";
const ENV_PI_EXECUTABLE = "JUNO_CONTROL_UI_I18N_PI_EXECUTABLE";
const ENV_PI_ARGS = "JUNO_CONTROL_UI_I18N_PI_ARGS";
const ENV_PI_PACKAGE_VERSION = "JUNO_CONTROL_UI_I18N_PI_PACKAGE_VERSION";
const ENV_BATCH_CHAR_BUDGET = "JUNO_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "JUNO_CONTROL_UI_I18N_PROMPT_TIMEOUT";
