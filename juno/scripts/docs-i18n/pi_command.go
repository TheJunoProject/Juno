...
const (
	envDocsPiExecutable     = "JUNO_DOCS_I18N_PI_EXECUTABLE"
	envDocsPiArgs           = "JUNO_DOCS_I18N_PI_ARGS"
	envDocsPiPackageVersion = "JUNO_DOCS_I18N_PI_PACKAGE_VERSION"
	envDocsPiOmitProvider   = "JUNO_DOCS_I18N_PI_OMIT_PROVIDER"
...
func getMaterializedPiRuntimeDir() (string, error) {
	...
	return filepath.Join(cacheDir, "juno", "docs-i18n", "pi-runtime", getMaterializedPiPackageVersion()), nil
}
