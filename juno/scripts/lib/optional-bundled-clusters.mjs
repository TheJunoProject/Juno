...
export const OPTIONAL_BUNDLED_BUILD_ENV = "JUNO_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.juno?.install?.npmSpec === "string" &&
    packageJson.juno.install.npmSpec.trim().length > 0
  );
}
