...
function printUsage(): void {
  console.log(`Juno CLI benchmark
...
Options:
  ...
  --entry <path>               Primary entry file (default: juno.mjs)
...
async function main(): Promise<void> {
  ...
  const tmpDir = mkdtempSync(path.join(os.tmpdir(), "juno-cli-bench-"));
