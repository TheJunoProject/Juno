...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']juno\/plugin-sdk["']/,
    hint: "Use juno/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']juno\/plugin-sdk\/test-utils["']/,
    hint: "Use juno/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']juno\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/plugins/* for repo-only helpers, or juno/plugin-sdk/testing for public surfaces.",
  },
  {
