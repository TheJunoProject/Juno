...
// legacy eager-install escape hatch is explicitly enabled; `juno doctor
...
const DISABLE_POSTINSTALL_ENV = "JUNO_DISABLE_BUNDLED_PLUGIN_POSTINSTALL";
const EAGER_BUNDLED_PLUGIN_DEPS_ENV = "JUNO_EAGER_BUNDLED_PLUGIN_DEPS";
  ...
  const createTempPath =
    ...
    ((unsafeTargetPath) =>
      join(
        ...
        `.${basename(unsafeTargetPath)}.juno-hotfix-${randomUUID()}`,
      ));
  const writeFile =
