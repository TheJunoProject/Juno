...
const env = {
  ...process.env,
  JUNO_LIVE_TEST: process.env.JUNO_LIVE_TEST || "1",
  JUNO_LIVE_TEST_QUIET: quietOverride ?? process.env.JUNO_LIVE_TEST_QUIET ?? "1",
};
...
const heartbeatMs = parsePositiveInt(process.env.JUNO_LIVE_WRAPPER_HEARTBEAT_MS, 20_000);
