...
function resolveSignalMaxBytes(cfg: JunoConfig, accountId?: string): number | undefined {
...
function resolveSignalTextChunkLimit(cfg: JunoConfig, accountId?: string | null): number {
  const signalCfg = cfg.channels?.signal as
    | {
