...
type LoginOpenAICodexOAuth =
  (typeof import("juno/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("juno/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
...
type EnsureAuthProfileStore =
  typeof import("juno/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("juno/plugin-sdk/provider-auth").listProfilesForProvider;
...
vi.mock("juno/plugin-sdk/provider-auth-login", async () => {
  const actual = await vi.importActual<typeof import("juno/plugin-sdk/provider-auth-login")>(
    "juno/plugin-sdk/provider-auth-login",
  );
  return {
    ...actual,
...
vi.mock("juno/plugin-sdk/provider-auth", async () => {
  const actual = await vi.importActual<typeof import("juno/plugin-sdk/provider-auth")>(
    "juno/plugin-sdk/provider-auth",
  );
  return {
    ...actual,
