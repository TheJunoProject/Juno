...
import type { JunoPluginApi } from "../../../src/plugins/types.js";
...
export function createPluginRegistryFixture(config = {} as JunoConfig) {
  return {
    config,
...
export function registerVirtualTestPlugin(params: {
  ...
  register(this: void, api: JunoPluginApi): void;
}) {
  registerTestPlugin({
