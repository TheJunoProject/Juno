import type { resolveProviderHttpRequestConfig } from "juno/plugin-sdk/provider-http";
...
vi.mock("juno/plugin-sdk/provider-auth-runtime", () => ({
  resolveApiKeyForProvider: providerHttpMocks.resolveApiKeyForProviderMock,
}));

vi.mock("juno/plugin-sdk/provider-http", () => ({
