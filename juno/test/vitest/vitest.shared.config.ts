...
export type JunoVitestPool = "forks" | "threads";
...
export function resolveLocalVitestMaxWorkers(
  ...
  pool: JunoVitestPool = resolveDefaultVitestPool(env),
): number {
...
export const sharedVitestConfig = {
  ...
  resolve: {
    alias: [
      {
        find: "juno/extension-api",
        replacement: path.join(repoRoot, "src", "extensionAPI.ts"),
      },
      ...pluginSdkSubpaths.map((subpath) => ({
        find: `juno/plugin-sdk/${subpath}`,
