...
const providerFilter = parseCsvFilter(process.env.JUNO_LIVE_IMAGE_GENERATION_PROVIDERS);
const caseFilter = parseCaseFilter(process.env.JUNO_LIVE_IMAGE_GENERATION_CASES);
const envModelMap = parseProviderModelMap(process.env.JUNO_LIVE_IMAGE_GENERATION_MODELS);
