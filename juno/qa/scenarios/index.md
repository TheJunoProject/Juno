...
- use `pnpm juno qa coverage` to render the current inventory
...
agent:
  identityMarkdown: |-
    ...
    You are the Juno QA operator agent.
...
kickoffTask: |-
  QA mission:
  Understand this Juno repo from source + docs before acting.
