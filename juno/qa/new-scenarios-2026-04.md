...
- Code: `.agents/skills/juno-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Flow:
  - Install a JunoHub or gateway-managed skill.
...
- Code: `src/agents/juno-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`
