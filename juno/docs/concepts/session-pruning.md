...
Juno also runs a separate idempotent cleanup for older legacy sessions that
...
Juno auto-enables pruning for Anthropic profiles:
...
If you set explicit values, Juno does not override them.
