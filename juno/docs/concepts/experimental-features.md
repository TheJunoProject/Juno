...
summary: "What experimental flags mean in Juno and which ones are currently documented"
read_when:
...
Experimental features in Juno are **opt-in preview surfaces**. They are
...
- If you are rolling Juno out broadly, test experimental flags in a smaller
...
| ------------------------ | --------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| Local model runtime      | `agents.defaults.experimental.localModelLean`             | A smaller or stricter local backend chokes on Juno's full default tool surface                             | [Local Models](/gateway/local-models)                                                         |
...
If a feature is experimental, Juno should say so plainly in docs and in the
