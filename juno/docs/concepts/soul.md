---
summary: "Use SOUL.md to give your Juno agent an actual voice instead of generic assistant sludge"
read_when:
...
Juno injects it on normal sessions, so it has real weight. If your agent
...
For Juno, `SOUL.md` is that layer.
...
Path fixed for Juno workspaces: use `SOUL.md`, not `http://SOUL.md`.
