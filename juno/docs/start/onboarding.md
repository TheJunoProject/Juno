---
summary: "First-run setup flow for Juno (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Juno">
...
<Step title="CLI">
  ...
  The app can install the global `juno` CLI via npm, pnpm, or bun.
