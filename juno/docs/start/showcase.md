---
title: "Showcase"
description: "Real-world Juno projects from the community"
summary: "Community-built projects and integrations powered by Juno"
read_when:
  - Looking for real Juno usage examples
...
<div className="showcase-hero">
  ...
  <p className="showcase-lead">
    Juno projects are not toy demos. People are shipping PR review loops, mobile apps, home automation,
  ...
  <div className="showcase-actions">
    ...
    <a href="https://discord.gg/junod">Share yours</a>
  </div>
...
<Info>
**Want to be featured?** Share your project in [#self-promotion on Discord](https://discord.gg/junod) or [tag @juno on X](https://x.com/juno).
</Info>
...
<div className="showcase-video-grid">
  <div className="showcase-video-card">
    <div className="showcase-video-shell">
      <iframe
        ...
        title="Juno: The self-hosted AI that Siri should have been (Full setup)"
        loading="lazy"
  ...
  <div className="showcase-video-card">
    ...
    <p>A faster pass across real projects, surfaces, and workflows built around Juno.</p>
...
OpenCode finishes the change → opens a PR → Juno reviews the diff and replies in Telegram with “minor suggestions” plus a clear merge verdict (including critical fixes to apply first).

  <img src="/assets/showcase/pr-review-telegram.jpg" alt="Juno PR review feedback delivered in Telegram" />
</Card>

<Card title="Wine Cellar Skill in Minutes" icon="wine-glass" href="https://x.com/i/status/2010916352454791216">
  **@prades_maxime** • `skills` `local` `csv`

Asked “Robby” (@juno) for a local wine cellar skill. It requests a sample CSV export + where to store it, then builds/tests the skill fast (962 bottles in the example).

  <img src="/assets/showcase/wine-cellar-skill.jpg" alt="Juno building a local wine cellar skill from CSV" />
</Card>
...
Desktop app to manage skills/commands across Agents, Claude, Codex, and Juno.
...
<Card title="CodexMonitor" icon="eye" href="https://junohub.ai/odrobnik/codexmonitor">
  **@odrobnik** • `devtools` `codex` `brew`

Homebrew-installed helper to list/inspect/watch local OpenAI Codex sessions (CLI + VS Code).

  <img src="/assets/showcase/codexmonitor.png" alt="CodexMonitor on JunoHub" />
</Card>

<Card title="Bambu 3D Printer Control" icon="print" href="https://junohub.ai/tobiasbischoff/bambu-cli">
  **@tobiasbischoff** • `hardware` `3d-printing` `skill`

Control and troubleshoot BambuLab printers: status, jobs, camera, AMS, calibration, and more.

  <img src="/assets/showcase/bambu-cli.png" alt="Bambu CLI skill on JunoHub" />
</Card>

<Card title="Vienna Transport (Wiener Linien)" icon="train" href="https://junohub.ai/hjanuschka/wienerlinien">
  **@hjanuschka** • `travel` `transport` `skill`

Real-time departures, disruptions, elevator status, and routing for Vienna's public transport.

  <img src="/assets/showcase/wienerlinien.png" alt="Wiener Linien skill on JunoHub" />
</Card>
...
<Card title="R2 Upload (Send Me My Files)" icon="cloud-arrow-up" href="https://junohub.ai/skills/r2-upload">
  **@julianengel** • `files` `r2` `presigned-urls`

Upload to Cloudflare R2/S3 and generate secure presigned download links. Perfect for remote Juno instances.
</Card>
...
14+ agents under one gateway with Opus 4.5 orchestrator delegating to Codex workers. Comprehensive [technical write-up](https://github.com/adam91holt/orchestrated-ai-articles) covering the Dream Team roster, model selection, sandboxing, webhooks, heartbeats, and delegation flows. [Junodspace](https://github.com/adam91holt/junodspace) for agent sandboxing. [Blog post](https://adams-ai-journey.ghost.io/2026-the-year-of-the-orchestrator/).
</Card>

<Card title="Linear CLI" icon="terminal" href="https://github.com/Finesssee/linear-cli">
  **@NessZerra** • `devtools` `linear` `cli` `issues`

CLI for Linear that integrates with agentic workflows (Claude Code, Juno). Manage issues, projects, and workflows from the terminal. First external PR merged!
</Card>
...
Claude Code discovered and confirmed the purifier controls, then Juno takes over to manage room air quality.

  <img src="/assets/showcase/winix-air-purifier.jpg" alt="Winix air purifier control via Juno" />
</Card>

<Card title="Pretty Sky Camera Shots" icon="camera" href="https://x.com/signalgaining/status/2010523120604746151">
  **@signalgaining** • `automation` `camera` `skill` `images`

Triggered by a roof camera: ask Juno to snap a sky photo whenever it looks pretty — it designed a skill and took the shot.

  <img src="/assets/showcase/roof-camera-sky.jpg" alt="Roof camera sky snapshot captured by Juno" />
</Card>

<Card title="Visual Morning Briefing Scene" icon="robot" href="https://x.com/buddyhadry/status/2010005331925954739">
  **@buddyhadry** • `automation` `briefing` `images` `telegram`

A scheduled prompt generates a single "scene" image each morning (weather, tasks, date, favorite post/quote) via an Juno persona.
</Card>
...
Juno connected to Jira, then generated a new skill on the fly (before it existed on JunoHub).
</Card>

<Card title="Todoist Skill via Telegram" icon="list-check" href="https://x.com/iamsubhrajyoti/status/2009949389884920153">
  **@iamsubhrajyoti** • `automation` `todoist` `skill` `telegram`

Automated Todoist tasks and had Juno generate the skill directly in Telegram chat.
</Card>
...
<Card title="xuezh Chinese Learning" icon="language" href="https://github.com/joshp123/xuezh">
  **@joshp123** • `learning` `voice` `skill`
  ...
  Chinese learning engine with pronunciation feedback and study flows via Juno.
...
<Card title="Junodia Phone Bridge" icon="phone" href="https://github.com/alejandroOPI/junodia-bridge">
  **@alejandroOPI** • `voice` `vapi` `bridge`
  
  Vapi voice assistant ↔ Juno HTTP bridge. Near real-time phone calls with your agent.
</Card>

<Card title="OpenRouter Transcription" icon="microphone" href="https://junohub.ai/obviyus/openrouter-transcribe">
  **@obviyus** • `transcription` `multilingual` `skill`

Multi-lingual audio transcription via OpenRouter (Gemini, etc). Available on JunoHub.
</Card>
...
<p className="showcase-section-intro">
  Packaging, deployment, and integrations that make Juno easier to run and extend.
</p>

<CardGroup cols={2}>

<Card title="Home Assistant Add-on" icon="home" href="https://github.com/ngutman/juno-ha-addon">
  **@ngutman** • `homeassistant` `docker` `raspberry-pi`
  
  Juno gateway running on Home Assistant OS with SSH tunnel support and persistent state.
</Card>

<Card title="Home Assistant Skill" icon="toggle-on" href="https://junohub.ai/skills/homeassistant">
  **JunoHub** • `homeassistant` `skill` `automation`
  
  Control and automate Home Assistant devices via natural language.
</Card>

<Card title="Nix Packaging" icon="snowflake" href="https://github.com/juno/nix-juno">
  **@juno** • `nix` `packaging` `deployment`
  
  Batteries-included nixified Juno configuration for reproducible deployments.
</Card>

<Card title="CalDAV Calendar" icon="calendar" href="https://junohub.ai/skills/caldav-calendar">
  **JunoHub** • `calendar` `caldav` `skill`
...
<p className="showcase-section-intro">
  The physical-world side of Juno: homes, sensors, cameras, vacuums, and other devices.
</p>
...
<Card title="GoHome Automation" icon="house-signal" href="https://github.com/joshp123/gohome">
  **@joshp123** • `home` `nix` `grafana`
  ...
  Nix-native home automation with Juno as the interface, plus beautiful Grafana dashboards.
...
<Card title="StarSwap Marketplace" icon="star" href="https://star-swap.com/">
  **Community** • `marketplace` `astronomy` `webapp`
  ...
  Full astronomy gear marketplace. Built with/around the Juno ecosystem.
</Card>
...
<p className="showcase-section-intro">
  If you are building something interesting with Juno, send it over. Strong screenshots and concrete outcomes help.
</p>
...
<Steps>
  <Step title="Share It">
    Post in [#self-promotion on Discord](https://discord.gg/junod) or [tweet @juno](https://x.com/juno)
  </Step>
