---
summary: "Overview of Juno onboarding options and flows"
read_when:
...
Juno has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `juno onboard`                     | Launch the app            |
...
CLI command docs: [`juno onboard`](/cli/onboard)

## macOS app onboarding

Open the Juno app. The first-run wizard walks you through the same steps
