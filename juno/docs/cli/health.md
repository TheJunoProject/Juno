---
summary: "CLI reference for `juno health` (gateway health snapshot via RPC)"
read_when:
...
- Default `juno health` asks the running gateway for its health snapshot. When the
