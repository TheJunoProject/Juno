...
If the active memory plugin exposes shared recall artifacts, Juno can search
...
currently exposing public bridge inputs yet. Run `juno wiki doctor` first,
...
juno wiki apply synthesis "Alpha Summary" --body "..." --source-id source.alpha
