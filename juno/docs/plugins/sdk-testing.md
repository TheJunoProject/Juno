...
summary: "Testing utilities and patterns for Juno plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for Juno
plugins.
...
**Import:** `juno/plugin-sdk/testing`
...
import { installCommonResolveTargetErrorCases } from "juno/plugin-sdk/testing";
...
import type { PluginRuntime } from "juno/plugin-sdk/runtime-store";
...
1. **No monolithic root imports** -- `juno/plugin-sdk` root barrel is rejected
...
Juno uses Vitest with V8 coverage thresholds. For plugin tests:
