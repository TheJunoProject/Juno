---
summary: "Messaging platforms Juno can connect to"
read_when:
  - You want to choose a chat channel for Juno
...
Juno can talk to you on any chat app you already use. Each channel connects via the Gateway.
...
- Channels can run simultaneously; configure multiple and Juno will route per chat.
