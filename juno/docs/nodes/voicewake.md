...
Juno treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.juno/settings/voicewake.json`

Shape:

```json
{ "triggers": ["juno", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
