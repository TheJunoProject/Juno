...
<Steps>
  ...
  <Step title="Configure Juno">
    Point Juno at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Juno
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native Juno integration with Claude CLI or API keys.
  </Card>
