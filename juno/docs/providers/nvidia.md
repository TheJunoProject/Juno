---
summary: "Use NVIDIA's OpenAI-compatible API in Juno"
read_when:
  - You want to use open models in Juno for free
...
<Steps>
  ...
  <Step title="Export the key and run onboarding">
    ...
    juno onboard --auth-choice skip
    ```
  </Step>
  <Step title="Set an NVIDIA model">
    ```bash
    juno models set nvidia/nvidia/nemotron-3-super-120b-a12b
    ```
  </Step>
</Steps>
