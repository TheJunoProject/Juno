...
read_when:
  - You want to use Together AI with Juno
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    juno onboard --auth-choice together-api-key
    ```
  </Step>
...
Juno ships this bundled Together catalog:
...
<AccordionGroup>
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `juno models list --provider together`
