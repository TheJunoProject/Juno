---
title: "fal"
summary: "fal image and video generation setup in Juno"
read_when:
  - You want to use fal image generation in Juno
...
Juno ships a bundled `fal` provider for hosted image and video generation.
...
<Steps>
  <Step title="Set the API key">
    ```bash
    juno onboard --auth-choice fal-api-key
    ```
  </Step>
...
<Tip>
Use `juno models list --provider fal` to see the full list of available fal
