---
summary: "Juno tools and plugins overview: what the agent can do and how to extend it"
read_when:
  - You want to understand what tools Juno provides
...
<Steps>
  ...
  <Step title="Plugins package everything together">
    ...
    Juno), others are **external** (published on npm by the community).
...
These tools ship with Juno and are available without installing any plugins:
...
| `group:juno`   | All built-in Juno tools (excludes plugin tools)                                                       |
