...
Juno has three public release lanes:
...
- Cross-OS install and upgrade runtime validation is dispatched from the
  ...
  `juno/releases-private/.github/workflows/juno-cross-os-release-checks.yml`,
  which invokes the reusable public workflow
  `.github/workflows/juno-cross-os-release-checks-reusable.yml`
...
- `Juno NPM Release` validation-only preflight also accepts the current
...
- Run `RELEASE_TAG=vYYYY.M.D node --import tsx scripts/juno-npm-release-check.ts`
  (or the matching beta/correction tag) before approval
- After npm publish, run
  `node --import tsx scripts/juno-npm-postpublish-verify.ts YYYY.M.D`
...
- Maintainer release automation now uses preflight-then-promote:
  ...
  - token-based npm dist-tag mutation now lives in
    `juno/releases-private/.github/workflows/juno-npm-dist-tags.yml`
...
`Juno NPM Release` accepts these operator-controlled inputs:
...
`Juno Release Checks` accepts these operator-controlled inputs:
...
1. Run `Juno NPM Release` with `preflight_only=true`
...
3. Run `Juno Release Checks` separately with the same tag or the
...
5. Run `Juno NPM Release` again with `preflight_only=false`, the same
...
- [`.github/workflows/juno-npm-release.yml`](https://github.com/juno/juno/blob/main/.github/workflows/juno-npm-release.yml)
- [`.github/workflows/juno-release-checks.yml`](https://github.com/juno/juno/blob/main/.github/workflows/juno-release-checks.yml)
- [`.github/workflows/juno-cross-os-release-checks-reusable.yml`](https://github.com/juno/juno/blob/main/.github/workflows/juno-cross-os-release-checks-reusable.yml)
- [`scripts/juno-npm-release-check.ts`](https://github.com/juno/juno/blob/main/scripts/juno-npm-release-check.ts)
- [`scripts/package-mac-dist.sh`](https://github.com/juno/juno/blob/main/scripts/package-mac-dist.sh)
- [`scripts/make_appcast.sh`](https://github.com/juno/juno/blob/main/scripts/make_appcast.sh)

Maintainers use the private release docs in
[`juno/maintainers/release/README.md`](https://github.com/juno/maintainers/blob/main/release/README.md)
