...
import { buildOauthProviderAuthResult } from "juno/plugin-sdk/provider-auth";
import { createProviderApiKeyAuthMethod } from "juno/plugin-sdk/provider-auth-api-key";
import { buildProviderReplayFamilyHooks } from "juno/plugin-sdk/provider-model-shared";
import { MINIMAX_FAST_MODE_STREAM_HOOKS } from "juno/plugin-sdk/provider-stream-family";
import { fetchMinimaxUsage } from "juno/plugin-sdk/provider-usage";
import { normalizeOptionalString } from "juno/plugin-sdk/text-runtime";
...
export function registerMinimaxProviders(api: JunoPluginApi) {
