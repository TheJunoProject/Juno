...
Official Voice Call plugin for **Juno**.
...
Docs: `https://docs.juno.ai/plugins/voice-call`
Plugin system: `https://docs.juno.ai/plugin`

## Install (local dev)

### Option A: install via Juno (recommended)
...
- advanced webhook, streaming, and tunnel notes: `https://docs.juno.ai/plugins/voice-call`
...
`https://docs.juno.ai/plugins/voice-call#stale-call-reaper`

## TTS for calls

Voice Call uses the core `messages.tts` configuration for
streaming speech on calls. Override examples and provider caveats live here:
`https://docs.juno.ai/plugins/voice-call#tts-for-calls`
