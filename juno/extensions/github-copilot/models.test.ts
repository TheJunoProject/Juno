...
vi.mock("juno/plugin-sdk/json-store", () => ({
  loadJsonFile,
  saveJsonFile,
}));

vi.mock("juno/plugin-sdk/state-paths", () => ({
  resolveStateDir: () => "/tmp/juno-state",
}));

import type { ProviderResolveDynamicModelContext } from "juno/plugin-sdk/core";
...
describe("github-copilot token", () => {
  const cachePath = "/tmp/juno-state/credentials/github-copilot.token.json";
