import type { ChannelDoctorLegacyConfigRule } from "juno/plugin-sdk/channel-contract";
import type { JunoConfig } from "juno/plugin-sdk/config-runtime";
import { isRecord } from "juno/plugin-sdk/text-runtime";
...
export function normalizeCompatibilityConfig({ cfg }: { cfg: JunoConfig }): {
  config: JunoConfig;
  changes: string[];
} {
