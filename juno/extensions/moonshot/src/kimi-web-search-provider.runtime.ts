...
function resolveKimiBaseUrl(kimi?: KimiConfig, openJunoConfig?: JunoConfig): string {
  ...
  const moonshotBaseUrl = openJunoConfig?.models?.providers?.moonshot?.baseUrl;
...
export async function executeKimiWebSearchProviderTool(
  ctx: { config?: JunoConfig; searchConfig?: SearchConfigRecord },
