...
import type { ModelDefinitionConfig } from "juno/plugin-sdk/provider-onboard";
import { type JunoConfig, withFetchPreconnect } from "juno/plugin-sdk/testing";
...
describe("Ollama provider", () => {
  const createAgentDir = () => mkdtempSync(join(tmpdir(), "juno-test-"));
  ...
  async function runOllamaCatalog(params: { config?: JunoConfig; env?: NodeJS.ProcessEnv }) {
