...
import { buildApiKeyCredential } from "juno/plugin-sdk/provider-auth";
import {
  ...
  register(api: JunoPluginApi) {
    ...
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "juno configure". ' +
        "See: https://docs.juno.ai/providers/ollama",
    });
  },
});
