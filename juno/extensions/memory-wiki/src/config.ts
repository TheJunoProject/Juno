...
import { buildPluginConfigSchema, z, type JunoPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: JunoPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".juno", "wiki", "main");
}
