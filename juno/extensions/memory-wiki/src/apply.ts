...
const GENERATED_START = "<!-- juno:wiki:generated:start -->";
const GENERATED_END = "<!-- juno:wiki:generated:end -->";
const HUMAN_START = "<!-- juno:human:start -->";
const HUMAN_END = "<!-- juno:human:end -->";
