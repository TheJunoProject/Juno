...
import { resolvePreferredJunoTmpDir, type JunoPluginApi } from "../api.js";
import {
...
export function registerDiffsPlugin(api: JunoPluginApi): void {
  ...
  const store = new DiffArtifactStore({
    rootDir: path.join(resolvePreferredJunoTmpDir(), "juno-diffs"),
    logger: api.logger,
  });
