import { buildPluginConfigSchema } from "juno/plugin-sdk/plugin-entry";
import { z } from "juno/plugin-sdk/zod";
import type { JunoPluginConfigSchema } from "../api.js";
import {
...
export const diffsPluginConfigSchema: JunoPluginConfigSchema = {
