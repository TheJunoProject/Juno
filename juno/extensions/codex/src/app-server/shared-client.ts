import { resolveJunoAgentDir } from "juno/plugin-sdk/provider-auth";
...
const SHARED_CODEX_APP_SERVER_CLIENT_STATE = Symbol.for("juno.codexAppServerClientState");
