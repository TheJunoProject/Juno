...
} from "juno/plugin-sdk/agent-harness";
...
describe("runCodexAppServerAttempt", () => {
  beforeEach(async () => {
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "juno-codex-run-"));
  });
  ...
  it("builds resume and turn params from the currently selected Juno model", () => {
