...
} from "juno/plugin-sdk/browser-node-runtime";
...
export function createBrowserPluginService(): JunoPluginService {
  ...
  return {
    ...
    start: async () => {
      ...
      handle = await startLazyPluginServiceModule({
        skipEnvVar: "JUNO_SKIP_BROWSER_CONTROL_SERVER",
        overrideEnvVar: "JUNO_BROWSER_CONTROL_MODULE",
