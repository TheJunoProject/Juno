...
import {
  ...
  sessionPathForFile,
} from "juno/plugin-sdk/memory-core-host-engine-qmd";
import type { MemorySearchResult } from "juno/plugin-sdk/memory-core-host-runtime-files";
import {
...
const LIGHT_SLEEP_EVENT_TEXT = "__juno_memory_core_light_sleep__";
const REM_SLEEP_EVENT_TEXT = "__juno_memory_core_rem_sleep__";
...
const MANAGED_DAILY_DREAMING_BLOCKS = [
  {
    heading: "## Light Sleep",
    startMarker: "<!-- juno:dreaming:light:start -->",
    endMarker: "<!-- juno:dreaming:light:end -->",
  },
  {
    heading: "## REM Sleep",
    startMarker: "<!-- juno:dreaming:rem:start -->",
    endMarker: "<!-- juno:dreaming:rem:end -->",
  },
] as const;
 ...
 */
export function registerMemoryDreamingPhases(_api: JunoPluginApi): void {
