...
import { resolveUserPath } from "juno/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "juno/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? "2) Reinstall Juno (this should install node-llama-cpp): npm i -g juno@latest"
      : null,
