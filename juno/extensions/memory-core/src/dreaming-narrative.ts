...
import { resolveGlobalMap } from "juno/plugin-sdk/global-singleton";
import { createAsyncLock } from "juno/plugin-sdk/infra-runtime";
import { resolveStateDir } from "juno/plugin-sdk/memory-core-host-runtime-core";
...
const DIARY_START_MARKER = "<!-- juno:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- juno:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "juno:dreaming:backfill-entry";
