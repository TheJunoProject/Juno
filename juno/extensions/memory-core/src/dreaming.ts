import { peekSystemEventEntries } from "juno/plugin-sdk/infra-runtime";
import type { JunoConfig, JunoPluginApi } from "juno/plugin-sdk/memory-core";
import {
...
} from "juno/plugin-sdk/memory-core-host-status";
...
const DREAMING_SYSTEM_EVENT_TEXT = "__juno_memory_core_short_term_promotion_dream__";
...
function resolveStartupConfigFromEvent(event: unknown, fallback: JunoConfig): JunoConfig {
  ...
  return startupCfg as JunoConfig;
}
...
export function registerShortTermPromotionDreaming(api: JunoPluginApi): void {
