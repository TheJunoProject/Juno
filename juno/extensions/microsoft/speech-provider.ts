...
import { isVoiceCompatibleAudio } from "juno/plugin-sdk/media-runtime";
import {
  captureHttpExchange,
  isDebugProxyGlobalFetchPatchInstalled,
} from "juno/plugin-sdk/proxy-capture";
import type {
  SpeechProviderConfig,
  SpeechProviderPlugin,
  SpeechVoiceOption,
} from "juno/plugin-sdk/speech";
import { asBoolean, asFiniteNumber, asObject, trimToUndefined } from "juno/plugin-sdk/speech";
