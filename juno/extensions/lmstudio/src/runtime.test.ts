...
vi.mock("juno/plugin-sdk/provider-auth-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("juno/plugin-sdk/provider-auth-runtime")>();
  return {
    ...actual,
