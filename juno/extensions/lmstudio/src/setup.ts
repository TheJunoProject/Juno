...
import { withAgentModelAliases } from "juno/plugin-sdk/provider-onboard";
import {
...
function stripLmstudioStoredAuthConfig(cfg: JunoConfig): JunoConfig {
...
function mergeDiscoveredLmstudioAllowlistEntries(params: {
  existing?: NonNullable<NonNullable<JunoConfig["agents"]>["defaults"]>["models"];
  discoveredModels: ModelDefinitionConfig[];
}) {
