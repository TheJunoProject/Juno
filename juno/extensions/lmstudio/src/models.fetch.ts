import { createSubsystemLogger } from "juno/plugin-sdk/logging-core";
import type { ModelDefinitionConfig } from "juno/plugin-sdk/provider-model-shared";
import { SELF_HOSTED_DEFAULT_COST } from "juno/plugin-sdk/provider-setup";
import { fetchWithSsrFGuard, type SsrFPolicy } from "juno/plugin-sdk/ssrf-runtime";
...
/** Discovers LLM models from LM Studio and maps them to Juno model definitions. */
