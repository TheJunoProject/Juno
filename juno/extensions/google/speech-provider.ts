import { assertOkOrThrowHttpError, postJsonRequest } from "juno/plugin-sdk/provider-http";
import type { JunoConfig } from "juno/plugin-sdk/provider-onboard";
import { normalizeResolvedSecretInputString } from "juno/plugin-sdk/secret-input";
import type {
  SpeechDirectiveTokenParseContext,
  SpeechProviderConfig,
  SpeechProviderOverrides,
  SpeechProviderPlugin,
} from "juno/plugin-sdk/speech-core";
import { asObject, trimToUndefined } from "juno/plugin-sdk/speech-core";
...
function resolveGoogleTtsModelProviderApiKey(cfg?: JunoConfig): string | undefined {
