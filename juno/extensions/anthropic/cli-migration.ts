...
type AgentDefaultsModel = NonNullable<NonNullable<JunoConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<JunoConfig["agents"]>["defaults"]>["models"];
