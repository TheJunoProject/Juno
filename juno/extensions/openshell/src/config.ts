...
import { buildPluginConfigSchema, type JunoPluginConfigSchema } from "juno/plugin-sdk/core";
import { z } from "juno/plugin-sdk/zod";
...
export function createOpenShellPluginConfigSchema(): JunoPluginConfigSchema {
