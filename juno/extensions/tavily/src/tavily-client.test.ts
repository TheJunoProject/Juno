...
vi.mock("juno/plugin-sdk/provider-web-search", () => ({
...
vi.mock("juno/plugin-sdk/security-runtime", () => ({
...
describe("tavily client X-Client-Source header", () => {
  ...
  it("runTavilySearch sends X-Client-Source: juno", async () => {
    ...
    expect(params.extraHeaders).toEqual({ "X-Client-Source": "juno" });
  });

  it("runTavilyExtract sends X-Client-Source: juno", async () => {
