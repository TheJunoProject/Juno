...
export function resolveTavilySearchConfig(cfg?: JunoConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: JunoConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: JunoConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
