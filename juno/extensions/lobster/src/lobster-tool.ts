...
import type { JunoPluginApi } from "../runtime-api.js";
import {
...
type BoundTaskFlow = ReturnType<
  NonNullable<JunoPluginApi["runtime"]>["taskFlow"]["bindSession"]
>;
...
export function createLobsterTool(api: JunoPluginApi, options?: LobsterToolOptions) {
