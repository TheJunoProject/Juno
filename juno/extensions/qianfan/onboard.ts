...
function resolveQianfanPreset(cfg: JunoConfig): {
  api: ModelApi;
  baseUrl: string;
...
export function applyQianfanProviderConfig(cfg: JunoConfig): JunoConfig {
  return qianfanPresetAppliers.applyProviderConfig(cfg);
}

export function applyQianfanConfig(cfg: JunoConfig): JunoConfig {
