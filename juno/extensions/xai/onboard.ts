...
>({
  ...
  resolveParams: (_cfg: JunoConfig, api) => ({
    providerId: "xai",
    api,
...
export function applyXaiProviderConfig(cfg: JunoConfig): JunoConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiResponsesApiConfig(cfg: JunoConfig): JunoConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiConfig(cfg: JunoConfig): JunoConfig {
