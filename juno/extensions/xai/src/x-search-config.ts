...
export function resolveLegacyXSearchConfig(config?: JunoConfig): JsonRecord | undefined {
...
export function resolvePluginXSearchConfig(config?: JunoConfig): JsonRecord | undefined {
...
export function resolveEffectiveXSearchConfig(config?: JunoConfig): JsonRecord | undefined {
