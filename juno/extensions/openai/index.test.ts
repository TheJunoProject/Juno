...
import * as providerAuth from "juno/plugin-sdk/provider-auth-runtime";
import * as providerHttp from "juno/plugin-sdk/provider-http";
...
vi.mock("juno/plugin-sdk/runtime-env", async () => {
  const actual = await vi.importActual<typeof import("juno/plugin-sdk/runtime-env")>(
    "juno/plugin-sdk/runtime-env",
  );
  return {
    ...actual,
