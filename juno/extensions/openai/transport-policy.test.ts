import type { ProviderRuntimeModel } from "juno/plugin-sdk/plugin-entry";
  ...
  it("builds native turn state for direct OpenAI routes", () => {
    expect(
      ...
      headers: {
        ...
        "x-juno-session-id": "session-123",
        "x-juno-turn-id": "turn-123",
        "x-juno-turn-attempt": "2",
      },
      metadata: {
        juno_session_id: "session-123",
        juno_turn_id: "turn-123",
        juno_turn_attempt: "2",
        juno_transport: "websocket",
      },
    });
  });
