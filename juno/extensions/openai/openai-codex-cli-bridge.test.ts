...
import { saveAuthProfileStore } from "juno/plugin-sdk/agent-runtime";
...
describe("prepareOpenAICodexCliExecution", () => {
  ...
  it("writes a private CODEX_HOME bridge from canonical Juno oauth", async () => {
    const agentDir = await fs.mkdtemp(path.join(os.tmpdir(), "juno-codex-cli-bridge-"));
