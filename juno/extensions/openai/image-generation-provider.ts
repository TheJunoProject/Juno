...
import type { ImageGenerationProvider } from "juno/plugin-sdk/image-generation";
import { isProviderApiKeyConfigured } from "juno/plugin-sdk/provider-auth";
import { resolveApiKeyForProvider } from "juno/plugin-sdk/provider-auth-runtime";
import {
  assertOkOrThrowHttpError,
  postJsonRequest,
  resolveProviderHttpRequestConfig,
} from "juno/plugin-sdk/provider-http";
...
function shouldAllowPrivateImageEndpoint(req: {
  ...
  return process.env.JUNO_QA_ALLOW_LOCAL_IMAGE_PROVIDER === "1";
}
