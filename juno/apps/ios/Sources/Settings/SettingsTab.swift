...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = JunoLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = JunoLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.juno.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section {
                    DisclosureGroup(isExpanded: self.$gatewayExpanded) {
                        ...
                        if !self.isGatewayConnected {
                            Text(
                                "1. Open a chat with your Juno agent and send /pair\n"
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected Juno agent.") { newValue in
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for Juno. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(JunoLocationMode.off.rawValue)
                            Text("While Using").tag(JunoLocationMode.whileUsing.rawValue)
                            Text("Always").tag(JunoLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while Juno is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("Juno", value: DeviceInfoHelper.openJunoVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = JunoLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private func friendlyGatewayMessage(from raw: String) -> String? {
        ...
        if lower.contains("pairing required") {
            return "Pairing required. Go back to your Juno chat and run /pair approve, then tap Connect again."
        }
