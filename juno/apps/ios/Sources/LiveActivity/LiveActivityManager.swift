...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.juno.ios", category: "LiveActivity")
    private var currentActivity: Activity<JunoActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = JunoActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<JunoActivityAttributes>.activities
    ...
    private func updateCurrent(state: JunoActivityAttributes.ContentState) {
    ...
    private func connectingState() -> JunoActivityAttributes.ContentState {
        JunoActivityAttributes.ContentState(
    ...
    private func idleState() -> JunoActivityAttributes.ContentState {
        JunoActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> JunoActivityAttributes.ContentState {
        JunoActivityAttributes.ContentState(
