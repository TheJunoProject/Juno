...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.juno.gateway"
    private static let nodeService = "ai.juno.node"
    private static let talkService = "ai.juno.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.juno.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.juno.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("juno-gateway.log")
    }
