...
final class CLIInstallPrompter {
    ...
    private let logger = Logger(subsystem: "ai.juno", category: "cli.prompt")
    ...
    func checkAndPromptIfNeeded(reason: String) {
        ...
        let alert = NSAlert()
        alert.messageText = "Install Juno CLI?"
    ...
    private func openSettings(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .junoSelectSettingsTab, object: tab)
        }
    }
