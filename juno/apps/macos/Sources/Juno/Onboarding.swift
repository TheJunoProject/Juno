...
enum UIStrings {
    static let welcomeTitle = "Welcome to Juno"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "juno.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: JunoChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g juno@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: JunoChatViewModel(
