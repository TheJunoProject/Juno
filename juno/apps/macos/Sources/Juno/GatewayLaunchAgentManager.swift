...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.juno", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".juno/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.junoCommand(
            subcommand: "gateway",
