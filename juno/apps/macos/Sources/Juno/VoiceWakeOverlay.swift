...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.juno", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Juno windows, but below the system’s pop-up menus.
