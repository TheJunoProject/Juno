...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = JunoConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = JunoConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: JunoConfigFile.loadDict(),
            draft: .init(
        ...
        JunoConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/juno"
        state.remoteCliPath = ""
        return state
    }
}
