...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.juno", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.juno", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [JunoChatMessage] = messages.compactMap { item in
