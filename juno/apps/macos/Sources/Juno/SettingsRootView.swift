...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .junoSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? JunoPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? JunoPaths.stateDirURL.path
...
extension Notification.Name {
    static let junoSelectSettingsTab = Notification.Name("junoSelectSettingsTab")
}
