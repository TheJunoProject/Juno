...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/juno/juno") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/juno/juno")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://juno.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "JunoBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "JunoBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "JunoGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "JunoGitCommit") as? String) ??
            "unknown"
    }
