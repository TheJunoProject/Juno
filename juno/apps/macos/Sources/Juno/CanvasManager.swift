...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.juno", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Juno/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__juno__/a2ui/").absoluteString + "?platform=macos"
    }
