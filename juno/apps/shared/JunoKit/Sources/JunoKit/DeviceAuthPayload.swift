...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: JunoProtocol.AnyCodable]?
    {
        ...
        return [
            "id": JunoProtocol.AnyCodable(identity.deviceId),
            "publicKey": JunoProtocol.AnyCodable(publicKey),
            "signature": JunoProtocol.AnyCodable(signature),
            "signedAt": JunoProtocol.AnyCodable(signedAtMs),
            "nonce": JunoProtocol.AnyCodable(nonce),
        ]
    }
}
