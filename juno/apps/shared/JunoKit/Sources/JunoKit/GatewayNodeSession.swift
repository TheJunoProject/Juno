...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.juno", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.juno", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: JunoProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
