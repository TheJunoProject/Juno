...
public enum JunoCanvasA2UICommand: String, Codable, Sendable {
...
public struct JunoCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct JunoCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
