...
public enum JunoTalkCommand: String, Codable, Sendable {
...
public struct JunoTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct JunoTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
