...
public struct JunoChatUsageCost: Codable, Hashable, Sendable {
...
public struct JunoChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: JunoChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(JunoChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct JunoChatMessageContent: Codable, Hashable, Sendable {
...
public struct JunoChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [JunoChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: JunoChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [JunoChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: JunoChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(JunoChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([JunoChatMessageContent].self, forKey: .content) {
...
public struct JunoChatHistoryPayload: Codable, Sendable {
...
public struct JunoSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct JunoSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [JunoSessionPreviewItem]
}

public struct JunoSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [JunoSessionPreviewEntry]

    public init(ts: Int, previews: [JunoSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct JunoChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct JunoChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct JunoAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct JunoChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct JunoGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct JunoPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: JunoPlatformImage?
...
public struct JunoChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
