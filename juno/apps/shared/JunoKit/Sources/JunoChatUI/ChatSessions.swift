...
public struct JunoChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct JunoChatSessionsDefaults: Codable, Sendable {
...
public struct JunoChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct JunoChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: JunoChatSessionsDefaults?
    public let sessions: [JunoChatSessionEntry]
