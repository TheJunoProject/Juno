...
@Suite struct GatewayErrorsTests {
    ...
    @Test func connectAuthErrorPreservesStructuredMetadata() {
        let error = GatewayConnectAuthError(
            ...
            actionCommand: "juno devices approve req-123",
            docsURLString: "https://docs.juno.ai/gateway/pairing",
        ...
        #expect(error.actionCommand == "juno devices approve req-123")
        #expect(error.docsURLString == "https://docs.juno.ai/gateway/pairing")
    ...
    @Test func pairingProblemUsesStructuredRequestMetadata() {
        ...
        #expect(problem?.actionCommand == "juno devices approve req-123")
    }
