...
import ai.juno.app.ui.mobileAccentBorderStrong
...
import ai.juno.app.ui.mobileSurface
import ai.juno.app.ui.mobileText
import ai.juno.app.ui.mobileTextSecondary
import ai.juno.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.juno.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.juno.app.ui.mobileFontFamily,
