    ...
    if (showDiagnostics) {
      Surface(
        ...
        Column(
          ...
          if (pairingRequired) {
            Text(
              "Approve this phone on the gateway. Juno retries automatically while this screen stays open.",
              style = mobileCallout,
              color = mobileTextSecondary,
            )
          ...
          Text("Juno Android ${openJunoAndroidVersionLabel()}", style = mobileCaption1, color = mobileTextSecondary)
          Button(
            onClick = {
            ...
            Spacer(modifier = Modifier.width(8.dp))
            Text("Copy Report for Juno", style = mobileCallout.copy(fontWeight = FontWeight.Bold))
          }
        }
      }
    }
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          CommandBlock("juno qr --setup-code-only")
          CommandBlock("juno qr --json")
          Text(
