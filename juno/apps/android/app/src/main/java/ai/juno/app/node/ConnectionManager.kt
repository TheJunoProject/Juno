...
import ai.juno.app.gateway.GatewayClientInfo
import ai.juno.app.gateway.GatewayConnectOptions
import ai.juno.app.gateway.GatewayEndpoint
import ai.juno.app.gateway.GatewayTlsParams
...
class ConnectionManager(
  ...
  fun buildUserAgent(): String {
    ...
    return "JunoAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions {
    return GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "juno-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(): GatewayConnectOptions {
    return GatewayConnectOptions(
      ...
      commands = emptyList(),
      permissions = emptyMap(),
      client = buildClientInfo(clientId = "juno-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )
  }
