...
describe("toSanitizedMarkdownHtml", () => {
  ...
  describe("explicit protocol links", () => {
    ...
    it("links http:// URLs", () => {
      const html = toSanitizedMarkdownHtml("Visit http://github.com/juno");
      expect(html).toContain('<a href="http://github.com/juno"');
    });
    ...
    it("does NOT rewrite explicit markdown links with CJK display text", () => {
      const html = toSanitizedMarkdownHtml("[Juno中文](https://docs.juno.ai)");
      expect(html).toContain('href="https://docs.juno.ai"');
      expect(html).toContain("Juno中文</a>");
    });
