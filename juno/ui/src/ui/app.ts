...
declare global {
  interface Window {
    __JUNO_CONTROL_UI_BASE_PATH__?: string;
  }
}
...
@customElement("juno-app")
export class JunoApp extends LitElement {
  ...
  @state() theme: ThemeName = this.settings.theme ?? "juno";
  ...
  @state() junohubSearchQuery = "";
  @state() junohubSearchResults: JunoHubSearchResult[] | null = null;
  @state() junohubSearchLoading = false;
  @state() junohubSearchError: string | null = null;
  @state() junohubDetail: JunoHubSkillDetail | null = null;
  @state() junohubDetailSlug: string | null = null;
  @state() junohubDetailLoading = false;
  @state() junohubDetailError: string | null = null;
  @state() junohubInstallSlug: string | null = null;
  @state() junohubInstallMessage: { kind: "success" | "error"; text: string } | null = null;
