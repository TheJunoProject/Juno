export type ThemeName = "juno" | "knot" | "dash";
...
export const VALID_THEME_NAMES = new Set<ThemeName>(["juno", "knot", "dash"]);
...
const LEGACY_MAP: Record<string, ThemeSelection> = {
  defaultTheme: { theme: "juno", mode: "dark" },
  docsTheme: { theme: "juno", mode: "light" },
  lightTheme: { theme: "knot", mode: "dark" },
  landingTheme: { theme: "knot", mode: "dark" },
  newTheme: { theme: "knot", mode: "dark" },
  dark: { theme: "juno", mode: "dark" },
  light: { theme: "juno", mode: "light" },
  openknot: { theme: "knot", mode: "dark" },
  fieldmanual: { theme: "dash", mode: "dark" },
  junodash: { theme: "dash", mode: "light" },
  system: { theme: "juno", mode: "system" },
};
