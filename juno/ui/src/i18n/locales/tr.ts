...
export const tr: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "juno.json dosyasını düzenleyin.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Mobilde misiniz? Masaüstünüzde juno dashboard --no-open komutundan tam URL'yi (#token=... dahil) kopyalayın.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — juno models auth ile yeniden kimlik doğrulayın",
