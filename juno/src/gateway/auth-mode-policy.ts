...
export function hasAmbiguousGatewayAuthModeConfig(cfg: JunoConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: JunoConfig): void {
