...
import { attachJunoTranscriptMeta, readSessionMessages } from "./session-utils.js";
...
export type SessionHistoryMessage = Record<string, unknown> & {
  __juno?: SessionHistoryTranscriptMeta;
};
...
export class SessionHistorySseState {
  ...
  appendInlineMessage(update: {
    ...
    const nextMessage = attachJunoTranscriptMeta(update.message, {
