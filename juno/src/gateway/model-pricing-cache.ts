...
export function collectConfiguredModelPricingRefs(config: JunoConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: JunoConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
