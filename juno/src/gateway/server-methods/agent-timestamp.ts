 ...
 *
 * @see https://github.com/juno/juno/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an JunoConfig.
 */
export function timestampOptsFromConfig(cfg: JunoConfig): TimestampInjectionOptions {
  return {
