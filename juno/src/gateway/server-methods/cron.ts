...
function listConfiguredAnnounceChannelIds(cfg: JunoConfig): string[] {
...
function assertValidCronAnnounceDelivery(params: { cfg: JunoConfig; delivery?: CronDelivery }) {
...
function assertValidCronCreateDelivery(cfg: JunoConfig, jobCreate: CronJobCreate) {
