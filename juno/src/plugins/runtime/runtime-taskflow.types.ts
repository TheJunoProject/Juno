...
import type { JunoPluginToolContext } from "../tool-types.js";
...
export type BoundTaskFlowRuntime = {
  ...
  cancel: (params: { flowId: string; cfg: JunoConfig }) => Promise<BoundTaskFlowCancelResult>;
  runTask: (params: {
    flowId: string;
    runtime: TaskRuntime;
    sourceId?: string;
...
export type PluginRuntimeTaskFlow = {
  ...
  fromToolContext: (
    ctx: Pick<JunoPluginToolContext, "sessionKey" | "deliveryContext">,
  ) => BoundTaskFlowRuntime;
};
