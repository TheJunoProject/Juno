...
import type { JunoPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: JunoPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): JunoPluginConfigSchema {
  return {
