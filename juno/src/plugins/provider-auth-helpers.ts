...
const resolveAuthAgentDir = (agentDir?: string) => agentDir ?? resolveJunoAgentDir();
...
function resolveProviderDefaultEnvSecretRef(provider: string, config?: JunoConfig): SecretRef {
