...
} from "juno/plugin-sdk/channel-contract";
import type {
  ChannelMessageActionContext as CoreChannelMessageActionContext,
  JunoPluginApi as CoreJunoPluginApi,
  PluginRuntime as CorePluginRuntime,
} from "juno/plugin-sdk/core";
import * as providerEntrySdk from "juno/plugin-sdk/provider-entry";
...
import type {
  ...
  JunoPluginApi as SharedJunoPluginApi,
...
import type { JunoPluginApi } from "../types.js";
...
describe("plugin-sdk subpath exports", () => {
  ...
  it("keeps the deprecated channel-runtime shim unused in repo imports", () => {
    const matches = findRepoFilesContaining({
      ...
      pattern: /juno\/plugin-sdk\/channel-runtime(?=["'])/u,
      exclude: [
  ...
  it("keeps shared plugin-sdk types aligned", () => {
    ...
    expectTypeOf<CoreJunoPluginApi>().toMatchTypeOf<JunoPluginApi>();
    expectTypeOf<CorePluginRuntime>().toMatchTypeOf<PluginRuntime>();
    expectTypeOf<CoreChannelMessageActionContext>().toMatchTypeOf<ChannelMessageActionContext>();
    expectTypeOf<CoreJunoPluginApi>().toMatchTypeOf<SharedJunoPluginApi>();
    expectTypeOf<CorePluginRuntime>().toMatchTypeOf<SharedPluginRuntime>();
    expectTypeOf<CoreChannelMessageActionContext>().toMatchTypeOf<SharedChannelMessageActionContext>();
  });

  it("keeps runtime entry subpaths importable", async () => {
    const coreSdk = await importResolvedPluginSdkSubpath("juno/plugin-sdk/core");
    ...
    const globalSingletonSdk = await importResolvedPluginSdkSubpath(
      "juno/plugin-sdk/global-singleton",
    );
    const textRuntimeSdk = await importResolvedPluginSdkSubpath("juno/plugin-sdk/text-runtime");
    const pluginEntrySdk = await importResolvedPluginSdkSubpath("juno/plugin-sdk/plugin-entry");
    ...
    for (const id of representativeRuntimeSmokeSubpaths) {
      representativeModules.push(await importResolvedPluginSdkSubpath(`juno/plugin-sdk/${id}`));
    }
