...
export const PLUGIN_MANIFEST_FILENAME = "juno.plugin.json";
...
export type PluginManifestQaRunner = {
  /** Subcommand mounted beneath `juno qa`, for example `matrix`. */
  commandName: string;
...
// package.json "juno" metadata (used for setup/catalog)
...
export type JunoPackageStartup = {
  /**
...
export type JunoPackageSetupFeatures = {
  legacyStateMigrations?: boolean;
  legacySessionSurfaces?: boolean;
};

export type JunoPackageManifest = {
  extensions?: string[];
  setupEntry?: string;
  setupFeatures?: JunoPackageSetupFeatures;
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
  startup?: JunoPackageStartup;
};
...
export type PackageManifest = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, JunoPackageManifest>>;

export function getPackageManifestMetadata(
  manifest: PackageManifest | undefined,
): JunoPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
