...
export function applyGoogleGeminiModelDefault(cfg: JunoConfig): {
  next: JunoConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: JunoConfig): JunoConfig {
...
export function applyOpenAIConfig(cfg: JunoConfig): JunoConfig {
...
export function applyOpencodeGoModelDefault(cfg: JunoConfig): {
  next: JunoConfig;
  changed: boolean;
} {
