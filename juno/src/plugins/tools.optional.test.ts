...
function expectLoaderCall(overrides: Record<string, unknown>) {
  expect(loadJunoPluginsMock).toHaveBeenCalledWith(expect.objectContaining(overrides));
}
