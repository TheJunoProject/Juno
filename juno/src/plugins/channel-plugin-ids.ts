...
function resolveGatewayStartupDreamingPluginIds(config: JunoConfig): Set<string> {
...
function resolveExplicitMemorySlotStartupPluginId(config: JunoConfig): string | undefined {
