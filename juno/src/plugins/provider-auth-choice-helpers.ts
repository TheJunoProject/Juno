...
export function applyProviderAuthConfigPatch(cfg: JunoConfig, patch: unknown): JunoConfig {
    ...
    agents: {
      ...
      defaults: {
        ...
        models: patchModels as NonNullable<
          NonNullable<JunoConfig["agents"]>["defaults"]
        >["models"],
      },
    },
  };
...
export function applyDefaultModel(cfg: JunoConfig, model: string): JunoConfig {
