...
import { normalizeJunoVersionBase } from "../config/version.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeJunoVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeJunoVersionBase(plugin.version) ??
    plugin.version
  );
}
