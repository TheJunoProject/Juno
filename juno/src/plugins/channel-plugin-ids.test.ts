...
describe("resolveGatewayStartupPluginIds", () => {
  beforeEach(() => {
    listPotentialConfiguredChannelIds.mockReset().mockImplementation((config: JunoConfig) => {
      if (Object.prototype.hasOwnProperty.call(config, "channels")) {
        return Object.keys(config.channels ?? {});
      }
      return ["demo-channel"];
    });
    hasPotentialConfiguredChannels.mockReset().mockImplementation((config: JunoConfig) => {
      if (Object.prototype.hasOwnProperty.call(config, "channels")) {
