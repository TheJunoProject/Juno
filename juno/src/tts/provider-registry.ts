...
function resolveSpeechProviderPluginEntries(cfg?: JunoConfig): SpeechProviderPlugin[] {
...
export function listSpeechProviders(cfg?: JunoConfig): SpeechProviderPlugin[] {
