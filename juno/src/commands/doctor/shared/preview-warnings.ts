...
function hasChannels(cfg: JunoConfig): boolean {
  return hasRecord(cfg.channels);
}

function hasPlugins(cfg: JunoConfig): boolean {
  return hasRecord(cfg.plugins);
}

function hasPluginLoadPaths(cfg: JunoConfig): boolean {
...
function hasExplicitChannelPluginBlockerConfig(cfg: JunoConfig): boolean {
...
function hasConfiguredSafeBins(cfg: JunoConfig): boolean {
