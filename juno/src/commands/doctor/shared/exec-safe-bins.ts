...
function collectExecSafeBinScopes(cfg: JunoConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: JunoConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: JunoConfig): {
  config: JunoConfig;
  changes: string[];
  warnings: string[];
} {
