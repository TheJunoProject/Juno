...
type SetupCommandDeps = {
  ...
  writeConfigFile?: (config: JunoConfig) => Promise<void>;
};
...
async function writeDefaultConfigFile(config: JunoConfig): Promise<void> {
...
async function readConfigFileRaw(configPath: string): Promise<{
  ...
  try {
    ...
    return { exists: true, parsed: (parsed ?? {}) as JunoConfig };
  } catch {
