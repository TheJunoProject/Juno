...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.juno.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("juno hooks list")}`,
      `  ${formatCliCommand("juno hooks enable <name>")}`,
      `  ${formatCliCommand("juno hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
