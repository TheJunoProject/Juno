...
import { replaceConfigFile, type JunoConfig } from "../../config/config.js";
...
async function resolveCatalogChannelEntry(raw: string, cfg: JunoConfig | null) {
...
export async function channelsAddCommand(
  ...
  const cfg = (configSnapshot.sourceConfig ?? configSnapshot.config) as JunoConfig;
  ...
  // May trigger loadJunoPlugins on cache miss (disk scan + jiti import)
