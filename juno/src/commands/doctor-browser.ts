...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: JunoConfig, deps?: BrowserDoctorDeps) => Promise<void>;
};
...
export async function noteChromeMcpBrowserReadiness(cfg: JunoConfig, deps?: BrowserDoctorDeps) {
  try {
