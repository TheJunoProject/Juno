...
function noteFlowRecoveryHints() {
  ...
  note(
    [
      ...
      `Inspect: ${formatCliCommand("juno tasks flow show <flow-id>")}`,
      `Cancel: ${formatCliCommand("juno tasks flow cancel <flow-id>")}`,
    ]
...
export function noteWorkspaceStatus(cfg: JunoConfig) {
