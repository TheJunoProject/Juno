...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://juno.local")).toBe("https://juno.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://juno.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: juno security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://juno.local" },
      ...
      { Item: "Security", Value: "Run: juno security audit --deep" },
