...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set JUNO_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `juno dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Juno.");
  } else if (hint) {
    runtime.log(hint);
  }
}
