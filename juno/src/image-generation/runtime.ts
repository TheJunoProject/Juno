...
function buildNoImageGenerationModelConfiguredMessage(cfg: JunoConfig): string {
...
export function listRuntimeImageGenerationProviders(params?: { config?: JunoConfig }) {
