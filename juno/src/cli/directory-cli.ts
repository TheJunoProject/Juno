    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["juno directory self --channel slack", "Show the connected account identity."],
          [
            'juno directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["juno directory groups list --channel discord", "List available groups/channels."],
          [
            "juno directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.juno.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
