...
describe("proxy cli runtime", () => {
  ...
  beforeEach(() => {
    tempDir = mkdtempSync(path.join(os.tmpdir(), "juno-proxy-cli-runtime-"));
    ...
    process.env.JUNO_DEBUG_PROXY_CERT_DIR = path.join(tempDir, "certs");
    delete process.env.JUNO_DEBUG_PROXY_ENABLED;
    delete process.env.JUNO_DEBUG_PROXY_SESSION_ID;
