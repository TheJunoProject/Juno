...
type ParseJunoHubPluginSpecFn = (typeof import("../infra/junohub.js"))["parseJunoHubPluginSpec"];
...
export const loadConfig: Mock<LoadConfigFn> = vi.fn<LoadConfigFn>(() => ({}) as JunoConfig);
...
export const replaceConfigFile: AsyncUnknownMock = vi.fn(
  async (params: { nextConfig: JunoConfig }) => await writeConfigFile(params.nextConfig),
) as AsyncUnknownMock;
export const resolveStateDir: Mock<() => string> = vi.fn(() => "/tmp/juno-state");
...
export const installPluginFromJunoHub: AsyncUnknownMock = vi.fn();
export const parseJunoHubPluginSpec: Mock<ParseJunoHubPluginSpecFn> = vi.fn();
...
vi.mock("../config/config.js", () => ({
  ...
  writeConfigFile: ((config: JunoConfig) =>
    invokeMock<
      [JunoConfig],
...
vi.mock("../plugins/enable.js", () => ({
  enablePluginInConfig: ((cfg: JunoConfig, pluginId: string) =>
    invokeMock<[JunoConfig, string], unknown>(
...
vi.mock("../plugins/junohub.js", () => ({
  JUNOHUB_INSTALL_ERROR_CODE: {
    PACKAGE_NOT_FOUND: "package_not_found",
    VERSION_NOT_FOUND: "version_not_found",
  },
  installPluginFromJunoHub: ((
    ...args: Parameters<(typeof import("../plugins/junohub.js"))["installPluginFromJunoHub"]>
  ) =>
    invokeMock<
      Parameters<(typeof import("../plugins/junohub.js"))["installPluginFromJunoHub"]>,
      ReturnType<(typeof import("../plugins/junohub.js"))["installPluginFromJunoHub"]>
    >(
      installPluginFromJunoHub,
      ...args,
    )) as (typeof import("../plugins/junohub.js"))["installPluginFromJunoHub"],
  formatJunoHubSpecifier: ({ name, version }: { name: string; version?: string }) =>
    `junohub:${name}${version ? `@${version}` : ""}`,
}));

vi.mock("../infra/junohub.js", () => ({
  parseJunoHubPluginSpec: ((
    ...args: Parameters<(typeof import("../infra/junohub.js"))["parseJunoHubPluginSpec"]>
  ) =>
    invokeMock<
      Parameters<(typeof import("../infra/junohub.js"))["parseJunoHubPluginSpec"]>,
      ReturnType<(typeof import("../infra/junohub.js"))["parseJunoHubPluginSpec"]>
    >(
      parseJunoHubPluginSpec,
      ...args,
    )) as (typeof import("../infra/junohub.js"))["parseJunoHubPluginSpec"],
}));
...
export function resetPluginsCliTestState() {
  ...
  installPluginFromJunoHub.mockReset();
  parseJunoHubPluginSpec.mockReset();
  ...
  applyExclusiveSlotSelection.mockImplementation((({ config }: { config: JunoConfig }) => ({
    config,
    warnings: [],
  })) as (...args: unknown[]) => unknown);
  uninstallPlugin.mockResolvedValue({
    ok: true,
    config: {} as JunoConfig,
    warnings: [],
    actions: {
      entry: false,
      install: false,
  ...
  installPluginFromJunoHub.mockResolvedValue({
    ok: false,
    error: "junohub install disabled in test",
  });
  parseJunoHubPluginSpec.mockReturnValue(null);
