...
const SANDBOX_EXAMPLES = {
  main: [
    ["juno sandbox list", "List all sandbox containers."],
    ["juno sandbox list --browser", "List only browser containers."],
    ["juno sandbox recreate --all", "Recreate all containers."],
    ["juno sandbox recreate --session main", "Recreate a specific session."],
    ["juno sandbox recreate --agent mybot", "Recreate agent containers."],
    ["juno sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["juno sandbox list", "List all sandbox containers."],
    ["juno sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["juno sandbox recreate --all", "Recreate all containers."],
    ["juno sandbox recreate --session main", "Recreate a specific session."],
    ["juno sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["juno sandbox recreate --browser --all", "Recreate only browser containers."],
    ["juno sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["juno sandbox explain", "Show effective sandbox config."],
    ["juno sandbox explain --session agent:main:main", "Explain a specific session."],
    ["juno sandbox explain --agent work", "Explain an agent sandbox."],
    ["juno sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.juno.ai/cli/sandbox")}\n`,
    )
    .action(() => {
