const DEFAULT_TAGLINE = "All your chats, one Juno.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little juno-sistant is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  "Your terminal just grew junos—type something and let the bot pinch the busywork.",
  ...
  "Automation with junos: minimal fuss, maximal pinch.",
  ...
  "Junos out, commit in—let's ship something mildly responsible.",
  ...
  "You had me at 'juno gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.JUNO_TAGLINE_INDEX;
