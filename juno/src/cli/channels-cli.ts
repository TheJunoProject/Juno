    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["juno channels list", "List configured channels and auth profiles."],
          ["juno channels status --probe", "Run channel status checks and probes."],
          [
            "juno channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["juno channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.juno.ai/cli/channels",
        )}\n`,
    );
