...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: JunoConfig): boolean {
  const key = plugin.id;
...
function resolveConfiguredAuthChannelInput(cfg: JunoConfig, mode: ChannelAuthMode): string {
