...
import { serveJunoChannelMcp } from "../mcp/channel-server.js";
...
export function registerMcpCli(program: Command) {
  const mcp = program.command("mcp").description("Manage Juno MCP config and channel bridge");

  mcp
    .command("serve")
    .description("Expose Juno channels over MCP stdio")
