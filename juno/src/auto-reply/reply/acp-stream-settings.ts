...
function resolveAcpStreamCoalesceIdleMs(cfg: JunoConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: JunoConfig): number {
...
export function resolveAcpProjectionSettings(cfg: JunoConfig): AcpProjectionSettings {
