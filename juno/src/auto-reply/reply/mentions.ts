...
function resolveMentionPatterns(cfg: JunoConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: JunoConfig | undefined, agentId?: string): RegExp[] {
