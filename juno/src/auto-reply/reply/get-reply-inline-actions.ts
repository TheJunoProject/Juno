...
type JunoToolsRuntime = typeof import("../../agents/juno-tools.runtime.js");
...
let openJunoToolsRuntimePromise: Promise<JunoToolsRuntime> | undefined;
...
function loadJunoToolsRuntime(): Promise<JunoToolsRuntime> {
  openJunoToolsRuntimePromise ??= import("../../agents/juno-tools.runtime.js");
  return openJunoToolsRuntimePromise;
}
...
export async function handleInlineActions(params: {
  ...
  if (skillInvocation) {
    ...
    if (dispatch?.kind === "tool") {
      ...
      const { createJunoTools } = await loadJunoToolsRuntime();
      const tools = createJunoTools({
