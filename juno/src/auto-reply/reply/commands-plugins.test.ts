...
vi.mock("../../cli/plugins-command-helpers.js", () => ({
  buildPreferredJunoHubSpec: vi.fn(() => null),
  createPluginInstallLogger: vi.fn(() => ({})),
  decidePreferredJunoHubFallback: vi.fn(() => "fallback_to_npm"),
...
vi.mock("../../infra/junohub.js", () => ({
  parseJunoHubPluginSpec: vi.fn(() => null),
}));

vi.mock("../../plugins/junohub.js", () => ({
  installPluginFromJunoHub: vi.fn(),
}));
...
vi.mock("../../plugins/toggle-config.js", () => ({
  setPluginEnabledInConfig: vi.fn((config: JunoConfig, id: string, enabled: boolean) => ({
    ...config,
    plugins: {
      ...config.plugins,
      entries: {
