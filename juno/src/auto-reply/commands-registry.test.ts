...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@juno", { botUsername: "juno" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@juno args", {
        botUsername: "juno",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "juno" })).toBe(
      "/help@otherbot",
    );
  });
