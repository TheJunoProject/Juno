/**
 * Hook system for Juno agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("juno.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("juno.internalHooksEnabled");
