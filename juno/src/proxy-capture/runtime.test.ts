...
describe("debug proxy runtime", () => {
  const envKeys = [
    ...
    "JUNO_DEBUG_PROXY_SOURCE_PROCESS",
  ] as const;
  ...
  beforeEach(() => {
    ...
    process.env.JUNO_DEBUG_PROXY_DB_PATH = "/tmp/juno-proxy-runtime-test.sqlite";
    process.env.JUNO_DEBUG_PROXY_BLOB_DIR = "/tmp/juno-proxy-runtime-test-blobs";
    process.env.JUNO_DEBUG_PROXY_SESSION_ID = "runtime-test-session";
    process.env.JUNO_DEBUG_PROXY_SOURCE_PROCESS = "runtime-test";
  });
