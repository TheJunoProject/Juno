...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.JUNO_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.JUNO_SERVICE_MARKER;
    vi.useRealTimers();
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.JUNO_SERVICE_MARKER = originalServiceMarker;
    }
  });
