...
export function listChannelMessageActions(cfg: JunoConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: JunoConfig): ChannelMessageCapability[] {
