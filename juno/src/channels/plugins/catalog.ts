...
import type { JunoPackageManifest } from "../../plugins/manifest.js";
...
const ENV_CATALOG_PATHS = ["JUNO_PLUGIN_CATALOG_PATHS", "JUNO_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<JunoPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
