import { sanitizeForPlainText } from "juno/plugin-sdk/outbound-runtime";
import {
...
export function resolveScopedChannelMediaMaxBytes(params: {
  cfg: JunoConfig;
  accountId?: string | null;
  resolveChannelLimitMb: (params: { cfg: JunoConfig; accountId: string }) => number | undefined;
}): number | undefined {
...
export function createScopedChannelMediaMaxBytesResolver(channel: string) {
  return (params: { cfg: JunoConfig; accountId?: string | null }) =>
