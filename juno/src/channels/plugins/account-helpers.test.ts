...
function cfg(accounts?: Record<string, unknown> | null, defaultAccount?: string): JunoConfig {
  if (accounts === null) {
    return {
      channels: {
  ...
  if (accounts === undefined && !defaultAccount) {
    return {} as unknown as JunoConfig;
  }
  return {
    channels: {
      testchannel: {
...
function expectResolvedDefaultAccountCase(input: JunoConfig, expected: string) {
