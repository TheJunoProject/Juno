...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: JunoConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: JunoConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: JunoConfig) => string;
  setAccountEnabled?: (params: {
    cfg: JunoConfig;
    accountId: string;
    enabled: boolean;
  }) => JunoConfig;
  deleteAccount?: (params: { cfg: JunoConfig; accountId: string }) => JunoConfig;
  isEnabled?: BivariantCallback<(account: ResolvedAccount, cfg: JunoConfig) => boolean>;
  disabledReason?: BivariantCallback<(account: ResolvedAccount, cfg: JunoConfig) => string>;
  isConfigured?: BivariantCallback<
    (account: ResolvedAccount, cfg: JunoConfig) => boolean | Promise<boolean>
  >;
  unconfiguredReason?: BivariantCallback<(account: ResolvedAccount, cfg: JunoConfig) => string>;
  describeAccount?: BivariantCallback<
    (account: ResolvedAccount, cfg: JunoConfig) => ChannelAccountSnapshot
  >;
  ...
  hasConfiguredState?: (params: { cfg: JunoConfig; env?: NodeJS.ProcessEnv }) => boolean;
  hasPersistedAuthState?: (params: { cfg: JunoConfig; env?: NodeJS.ProcessEnv }) => boolean;
...
export type ChannelStatusAdapter<ResolvedAccount, Probe = unknown, Audit = unknown> = {
  ...
  probeAccount?: BivariantCallback<
    (params: { account: ResolvedAccount; timeoutMs: number; cfg: JunoConfig }) => Promise<Probe>
  >;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.juno.ai/plugins/building-plugins | Plugin SDK documentation}
   */
...
export type ChannelGatewayAdapter<ResolvedAccount = unknown> = {
  ...
  resolveGatewayAuthBypassPaths?: (params: { cfg: JunoConfig }) => string[];
...
export type ChannelDoctorAdapter = {
  ...
  normalizeCompatibilityConfig?: (params: { cfg: JunoConfig }) => ChannelDoctorConfigMutation;
...
export type ChannelApprovalDeliveryAdapter = {
  hasConfiguredDmRoute?: (params: { cfg: JunoConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: JunoConfig; accountId?: string | null }) =>
    | {
...
export type ChannelConversationBindingSupport = {
  ...
  createManager?: (params: { cfg: JunoConfig; accountId?: string | null }) =>
    | {
