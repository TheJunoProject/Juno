...
export function isAcpEnabledByPolicy(cfg: JunoConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: JunoConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: JunoConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: JunoConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: JunoConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: JunoConfig, agentId: string): boolean {
