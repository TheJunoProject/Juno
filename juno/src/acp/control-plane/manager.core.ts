...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: JunoConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: JunoConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: JunoConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: JunoConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: JunoConfig }): Promise<void> {
