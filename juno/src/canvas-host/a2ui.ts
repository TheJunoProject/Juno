...
export const A2UI_PATH = "/__juno__/a2ui";

export const CANVAS_HOST_PATH = "/__juno__/canvas";

export const CANVAS_WS_PATH = "/__juno__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.junoCanvasA2UIAction.postMessage(...)
  // - Android: window.junoCanvasA2UIAction.postMessage(...)
  const handlerNames = ["junoCanvasA2UIAction"];
  ...
  globalThis.Juno = globalThis.Juno ?? {};
  globalThis.Juno.postMessage = postToNode;
  globalThis.Juno.sendUserAction = sendUserAction;
  globalThis.junoPostMessage = postToNode;
  globalThis.junoSendUserAction = sendUserAction;
