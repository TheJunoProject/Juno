...
function configWithSlot(engineId: string): JunoConfig {
...
describe("Invalid engine fallback", () => {
  ...
  it("throws when the default engine itself is not registered", async () => {
    ...
    const registryState = (globalThis as Record<symbol, unknown>)[
      Symbol.for("juno.contextEngineRegistryState")
...
// lossless-juno registered successfully but resolution could not find it.
// ═══════════════════════════════════════════════════════════════════════════
