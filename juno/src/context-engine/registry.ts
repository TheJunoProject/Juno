...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("juno.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("juno.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: JunoConfig): Promise<ContextEngine> {
