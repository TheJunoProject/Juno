...
describe("local media roots", () => {
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "juno-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "juno-agent-media-roots-state"),
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "juno-flexible-media-roots-state"),
      cfg: {},
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "juno-messaging-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "juno-messaging-fs-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
  ...
  it("keeps the config-dir media cache root when state and config paths differ", () => {
    const stateDir = path.join("/tmp", "juno-legacy-state");
    const configDir = path.join("/tmp", "juno-current-config");
