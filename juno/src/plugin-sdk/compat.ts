...
const shouldWarnCompatImport =
  ...
  process.env.JUNO_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "juno/plugin-sdk/compat is deprecated for new plugins. Migrate to focused juno/plugin-sdk/<subpath> imports. See https://docs.juno.ai/plugins/sdk-migration",
    {
      code: "JUNO_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.juno.ai/plugins/sdk-migration",
    },
  );
}
