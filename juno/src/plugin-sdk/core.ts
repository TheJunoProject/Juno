...
import type { JunoPluginApi } from "../plugins/types.js";
...
export type { JunoPluginToolContext, JunoPluginToolFactory } from "../plugins/types.js";
export type {
...
type DefineChannelPluginEntryOptions<TPlugin = ChannelPlugin> = {
  ...
  registerCliMetadata?: (api: JunoPluginApi) => void;
  registerFull?: (api: JunoPluginApi) => void;
};
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: JunoConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
