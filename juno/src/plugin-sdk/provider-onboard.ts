...
export type { JunoConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: JunoConfig, ...args: TArgs) => JunoConfig;
  applyConfig: (cfg: JunoConfig, ...args: TArgs) => JunoConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: JunoConfig, preset: TParams) => JunoConfig;
  primaryModelRef: string;
...
export function applyOpencodeZenModelDefault(cfg: JunoConfig): {
  next: JunoConfig;
  changed: boolean;
} {
