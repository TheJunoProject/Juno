...
import type { ModelProviderConfig, JunoConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyOpenrouterConfig: (cfg: JunoConfig) => JunoConfig;
  applyOpenrouterProviderConfig: (cfg: JunoConfig) => JunoConfig;
