...
import type { ModelDefinitionConfig, JunoConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyLitellmConfig: (cfg: JunoConfig) => JunoConfig;
  applyLitellmProviderConfig: (cfg: JunoConfig) => JunoConfig;
