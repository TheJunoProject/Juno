...
const FACADE_LOADER_GLOBAL = "__junoTestLoadBundledPluginPublicSurfaceModuleSync";
...
describe("plugin-sdk facade loader", () => {
  it("honors bundled plugin dir overrides outside the package root", () => {
    const overrideA = createBundledPluginDir("juno-facade-loader-a-", "override-a");
    const overrideB = createBundledPluginDir("juno-facade-loader-b-", "override-b");
  ...
  it("shares loaded facade ids with facade-runtime", () => {
    const dir = createBundledPluginDir("juno-facade-loader-ids-", "identity-check");
  ...
  it("keeps Windows dist facade loads off Jiti native import", () => {
    const dir = createTempDirSync("juno-facade-loader-windows-dist-");
  ...
  it("breaks circular facade re-entry during module evaluation", () => {
    const dir = createCircularPluginDir("juno-facade-loader-circular-");
    process.env.JUNO_BUNDLED_PLUGINS_DIR = dir;
  ...
  it("clears the cache on load failure so retries re-execute", () => {
    const dir = createThrowingPluginDir("juno-facade-loader-throw-");
    process.env.JUNO_BUNDLED_PLUGINS_DIR = dir;
