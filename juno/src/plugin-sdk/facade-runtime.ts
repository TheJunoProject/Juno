...
const JUNO_SOURCE_EXTENSIONS_ROOT = path.resolve(JUNO_PACKAGE_ROOT, "extensions");
...
function buildFacadeActivationCheckParams(
  ...
  return {
    ...params,
    location,
    sourceExtensionsRoot: JUNO_SOURCE_EXTENSIONS_ROOT,
    resolutionKey: createFacadeResolutionKey(params),
  };
}
