...
type ChannelConfigAccessorParams<Config extends JunoConfig = JunoConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends JunoConfig = JunoConfig,
> = {
  sectionKey: string;
...
export function adaptScopedAccountAccessor<Result, Config extends JunoConfig = JunoConfig>(
...
> {
  const base = {
    resolveAllowFrom({ cfg, accountId }: { cfg: JunoConfig; accountId?: string | null }) {
...
function setTopLevelChannelEnabledInConfigSection<Config extends JunoConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends JunoConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends JunoConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
