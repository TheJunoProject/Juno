export const INTERNAL_RUNTIME_CONTEXT_BEGIN = "<<<BEGIN_JUNO_INTERNAL_CONTEXT>>>";
export const INTERNAL_RUNTIME_CONTEXT_END = "<<<END_JUNO_INTERNAL_CONTEXT>>>";

const ESCAPED_INTERNAL_RUNTIME_CONTEXT_BEGIN = "[[JUNO_INTERNAL_CONTEXT_BEGIN]]";
const ESCAPED_INTERNAL_RUNTIME_CONTEXT_END = "[[JUNO_INTERNAL_CONTEXT_END]]";
