...
export const DEFAULT_SANDBOX_IMAGE = "juno-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "juno-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "juno-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "juno-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-04-05-cdp-source-range";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "juno-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "juno-sandbox-browser";
