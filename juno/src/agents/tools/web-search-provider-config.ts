...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<JunoConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<JunoConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: JunoConfig): WebSearchConfig {
