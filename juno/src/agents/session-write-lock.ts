...
const CLEANUP_STATE_KEY = Symbol.for("juno.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("juno.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("juno.sessionWriteLockWatchdogState");
