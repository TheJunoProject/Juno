...
function createProviderRuntimeSmokeContext(): {
  ...
  delete env.JUNO_BUNDLED_PLUGINS_DIR;
  delete env.JUNO_SKIP_PROVIDERS;
  delete env.JUNO_SKIP_CHANNELS;
  delete env.JUNO_SKIP_CRON;
  delete env.JUNO_TEST_MINIMAL_GATEWAY;
  return {
    config: {},
    env,
