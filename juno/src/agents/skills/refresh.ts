...
function resolveWatchPaths(workspaceDir: string, config?: JunoConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: JunoConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: JunoConfig }) {
