...
export function isConfigPathTruthy(config: JunoConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["juno-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: JunoConfig): string[] | undefined {
