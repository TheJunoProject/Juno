...
export const FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE = "juno:bootstrap-context:full";
...
export function resolveContextInjectionMode(config?: JunoConfig): AgentContextInjection {
