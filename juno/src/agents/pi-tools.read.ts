...
function resolveAdaptiveReadMaxBytes(options?: JunoReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createJunoReadTool(base, {
...
export function createJunoReadTool(
  base: AnyAgentTool,
  options?: JunoReadToolOptions,
): AnyAgentTool {
  return {
    ...base,
