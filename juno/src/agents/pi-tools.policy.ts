...
export function resolveSubagentToolPolicy(cfg?: JunoConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: JunoConfig["tools"]): string[] | undefined {
