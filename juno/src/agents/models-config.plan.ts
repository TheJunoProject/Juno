...
type ModelsConfig = NonNullable<JunoConfig["models"]>;
...
export async function planJunoModelsJsonWithDeps(
  params: {
    cfg: JunoConfig;
...
export async function planJunoModelsJson(
  params: Parameters<typeof planJunoModelsJsonWithDeps>[0],
): Promise<ModelsJsonPlan> {
  return planJunoModelsJsonWithDeps(params);
}
