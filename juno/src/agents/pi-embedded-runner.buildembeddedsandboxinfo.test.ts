...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/juno-sandbox",
    agentWorkspaceDir: "/tmp/juno-workspace",
    workspaceAccess: "none",
    runtimeId: "juno-sbx-test",
    runtimeLabel: "juno-sbx-test",
    containerName: "juno-sbx-test",
    ...
    browser: {
      ...
      containerName: "juno-sbx-browser-test",
    },
