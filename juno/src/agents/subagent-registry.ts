...
type SubagentRegistryDeps = {
  ...
  resolveContextEngine?: (cfg: JunoConfig) => Promise<ContextEngine>;
};
...
async function resolveSubagentRegistryContextEngine(cfg: JunoConfig) {
...
function resolveSubagentWaitTimeoutMs(cfg: JunoConfig, runTimeoutSeconds?: number) {
