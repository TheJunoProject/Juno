...
const SIMPLE_TRANSPORT_API_ALIAS: Record<string, Api> = {
  "openai-responses": "juno-openai-responses-transport",
  "openai-codex-responses": "juno-openai-responses-transport",
  "openai-completions": "juno-openai-completions-transport",
  "azure-openai-responses": "juno-azure-openai-responses-transport",
  "anthropic-messages": "juno-anthropic-messages-transport",
  "google-generative-ai": "juno-google-generative-ai-transport",
};
