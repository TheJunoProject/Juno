...
export function listAuthProfileStorePaths(config: JunoConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: JunoConfig, stateDir: string): string[] {
