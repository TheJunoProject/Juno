...
function resolveResolutionLimits(config: JunoConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: JunoConfig): SecretProviderConfig {
