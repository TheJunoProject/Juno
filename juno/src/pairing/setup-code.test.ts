...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("JUNO_GATEWAY_TOKEN", "");
    vi.stubEnv("JUNO_GATEWAY_PASSWORD", "");
    vi.stubEnv("JUNO_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses JUNO_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
