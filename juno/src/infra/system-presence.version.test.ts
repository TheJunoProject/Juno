  ...
  return withEnvAsync(
    {
      ...
      JUNO_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when JUNO_VERSION is not set", async () => {
  ...
  it("prefers JUNO_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over JUNO_SERVICE_VERSION when JUNO_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        JUNO_VERSION: " ",
        JUNO_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when JUNO_VERSION and JUNO_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        JUNO_VERSION: " ",
        JUNO_SERVICE_VERSION: "\t",
