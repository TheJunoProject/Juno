...
let originalJunoTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalJunoTestConsole = process.env.JUNO_TEST_CONSOLE;
  process.env.JUNO_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalJunoTestConsole === undefined) {
    delete process.env.JUNO_TEST_CONSOLE;
  } else {
    process.env.JUNO_TEST_CONSOLE = originalJunoTestConsole;
  }
