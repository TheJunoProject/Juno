...
export type JunoConfig = {
  ...
  $schema?: string;
  meta?: {
    /** Last Juno version that wrote this config. */
  ...
  ui?: {
    /** Accent color for Juno UI chrome (hex). */
    seamColor?: string;
    assistant?: {
...
declare const openJunoConfigStateBrand: unique symbol;

type BrandedConfigState<TState extends string> = JunoConfig & {
  readonly [openJunoConfigStateBrand]?: TState;
};
