...
export function applyMessageDefaults(cfg: JunoConfig): JunoConfig {
...
export function applyTalkConfigNormalization(config: JunoConfig): JunoConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: JunoConfig): JunoConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: JunoConfig): JunoConfig {
...
export function applyLoggingDefaults(cfg: JunoConfig): JunoConfig {
...
function hasAnthropicDefaultSignal(cfg: JunoConfig, env: NodeJS.ProcessEnv): boolean {
...
export function applyContextPruningDefaults(cfg: JunoConfig): JunoConfig {
...
export function applyCompactionDefaults(cfg: JunoConfig): JunoConfig {
