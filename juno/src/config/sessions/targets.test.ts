...
function createCustomRootCfg(customRoot: string, defaultAgentId = "ops"): JunoConfig {
  return {
    session: {
...
const discoveryResolvers = [
  {
    label: "async",
    resolve: async (cfg: JunoConfig, env: NodeJS.ProcessEnv) =>
