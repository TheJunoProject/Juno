...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.JUNO_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.JUNO_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.JUNO_WATCH_COMMAND),
