...
let runtimeConfigSnapshot: JunoConfig | null = null;
let runtimeConfigSourceSnapshot: JunoConfig | null = null;
...
export function getRuntimeConfigSourceSnapshot(): JunoConfig | null {
...
export function loadPinnedRuntimeConfig(loadFresh: () => JunoConfig): JunoConfig {
...
export async function finalizeRuntimeSnapshotWrite(params: {
  nextSourceConfig: JunoConfig;
  hadRuntimeSnapshot: boolean;
  hadBothSnapshots: boolean;
  loadFreshConfig: () => JunoConfig;
