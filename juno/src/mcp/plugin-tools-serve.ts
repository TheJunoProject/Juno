/**
 * Standalone MCP server that exposes Juno plugin-registered tools
...
function resolveTools(config: JunoConfig): AnyAgentTool[] {
...
export function createPluginToolsMcpServer(
  ...
  const server = new Server(
    { name: "juno-plugin-tools", version: VERSION },
    { capabilities: { tools: {} } },
  );
