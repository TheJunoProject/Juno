...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: JunoConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: JunoConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: JunoConfig;
  agentDir?: string;
  listProviders: (cfg?: JunoConfig) => CapabilityProviderCandidate[];
}): string[] {
