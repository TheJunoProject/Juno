...
- Signal: "update fly" => `fly ssh console -a flawd-bot -C "bash -lc 'cd /data/juno/juno && git pull --rebase origin main'"` then `fly machines restart e825232f34d058 -a flawd-bot`.
